...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create personal-website-572a
  fly apps create personal-website-572a-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app personal-website-572a
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app personal-website-572a-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'personal-website-572a-staging' does not match app name in config file 'personal-website-572a'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name personal-website-572a-db
  fly postgres attach --app personal-website-572a personal-website-572a-db

  fly postgres create --name personal-website-572a-staging-db
  fly postgres attach --app personal-website-572a-staging personal-website-572a-staging-db
  ```
